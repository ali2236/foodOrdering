...
public class PersianCalendar extends GregorianCalendar {
    ...
    public static String[] WEEK_DAYS = new String[]{"شنبه", "یکشنبه", "دوشنبه", "سه‌شنبه", "چهارشنبه", "پنجشنبه", "جمعه"};
    private static String[] Month_Days = new String[]{"یکم", "دوم", "سوم", "چهارم", "پنجم", "ششم"
            , "هفتم", "هشتم", "نهم", "دهم", "یازدهم", "دوازدهم", "سیزدهم", "چهاردهم", "پانزدهم", "شانزدهم"
            , "هفدهم", "هیجدهم", "نوزدهم", "بیستم", "بیست و یکم", "بیست و دوم", "بیست و سوم", "بیست و چهارم"
    ...
    public long convertToMilis(long julianDate) {
    ...
    public String getPersianYearStr() {
        return toPersianNumber(String.valueOf(this.persianYear));
    }
    ...
    public String getPersianCalendarTitle() {
        return MONTH_NAME[persianMonth - 1] + " ماه " + toPersianNumber(String.valueOf(persianYear));
    }
    ...
    public String getPersianDayofMonthName() {
        return Month_Days[this.persianDay - 1];
    }
